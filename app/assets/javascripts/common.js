  ...
  function correct_label(){
    $(function(){
      ...
      constructor(optionsParam) {
        ...
        if (gon.question_correct == 1) {
          this.color1 = options.color1 || '#69ff00';
          this.color2 = options.color2 || '#00ffef';
          this.color3 = options.color3 || '#c5fff8';
          this.textColor = options.textColor || '#ffffff';
        } else {
          this.color1 = options.color1 || '#000000';
          this.color2 = options.color2 || '#ff0000';
          this.color3 = options.color3 || '#ffc5c5';
          this.textColor = options.textColor || '#ffffff';
        }
        ...
        if (gon.question_correct == 1) {
          this.text    = options.text    || '正解';
        } else{
          this.text    = options.text    || '不正解';
        }
        this.canvas  = options.canvas  || document.createElement('canvas');
        this.context = this.canvas.getContext('2d');
        this.wrapperElement = options.wrapperElement || document.body;
        if (!this.canvas.parentElement) {
          $("#practice_left_answer_result").append(this.canvas);
        }
        this.touches = [];
